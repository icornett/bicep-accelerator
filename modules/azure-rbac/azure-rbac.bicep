...
@description('The role definition id, or it will be looked up by name')
param roleDefinitionIdOrName string
@description('The name of the resource to attach the policy to. Used for creating the Guid')
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for principalId in principalIds: {
  name: guid(resource_name, principalId, roleDefinitionIdOrName)
  properties: {
